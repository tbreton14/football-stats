...
//            }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            BooleanField::new('playingPersonnal', "Gestion perso du calendrier")->hideOnIndex(),
            BooleanField::new('isDefault', "Compétition défaut"),
            BooleanField::new('isChampionnat', "Compétition défaut")->hideOnIndex(),
            BooleanField::new('typePhase1ModeChampionnat', "Compétition défaut")->hideOnIndex(),
